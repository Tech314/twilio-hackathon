    ...
    try {
        ...
        if (isMobile(twilioRes)) {
            ...
            twilioClient.client.messages.create({
                body: `Thank you for your interest in Credit One Bank’s real-time video support. Click the link below to connect with your personal Account Manager, standing by to answer all your questions. https://creditoneblack.com/hackathon?name=${roomId}`,
